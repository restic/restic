...
_restic_forget()
{
    ...
    local_nonpersistent_flags+=("--repack-smaller-than=")
    flags+=("--max-pack-unused=")
    two_word_flags+=("--max-pack-unused")
    local_nonpersistent_flags+=("--max-pack-unused")
    local_nonpersistent_flags+=("--max-pack-unused=")
    flags+=("--ignore-pack-unused=")
    two_word_flags+=("--ignore-pack-unused")
    local_nonpersistent_flags+=("--ignore-pack-unused")
    local_nonpersistent_flags+=("--ignore-pack-unused=")
    flags+=("--help")
    flags+=("-h")
    local_nonpersistent_flags+=("--help")
