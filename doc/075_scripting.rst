...
perhaps to prevent your script from trying to initializing a repository multiple
...
If a repository does not exist, restic (since 0.17.0) will return exit code ``5``
...
.. warning::
    ...
    MUST treat as a command failure.
