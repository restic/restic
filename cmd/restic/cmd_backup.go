...
func init() {
	...
	f.StringVar(&backupOptions.Hostname, "hostname", os.Getenv("RESTIC_HOSTNAME"), "set the `hostname` for the snapshot (default: $RESTIC_HOSTNAME or the system hostname)")
