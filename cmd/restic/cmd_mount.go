...
// this is a stub to be able to check for forbidden characters in the template
func runMountCheck(ctx context.Context, opts MountOptions, gopts global.Options, args []string, term ui.Terminal) error {
