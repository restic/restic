...
// CustomDomain is customer provided domain for branding purposes, e.g. www.consoto.com.
...
// EndpointPropertiesUpdateParameters is result of the request to list endpoints. It contains a list of endpoints and a
...
// SupportedOptimizationTypesResult is the result of the GetSupportedOptimizationTypes API
