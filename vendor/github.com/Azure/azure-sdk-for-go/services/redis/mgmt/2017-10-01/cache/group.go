...
func (client GroupClient) Create(resourceGroupName string, name string, parameters ResourceType, cancel <-chan struct{}) (<-chan ResourceType, <-chan error) {
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.Properties", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "parameters.Properties.Sku", Name: validation.Null, Rule: true,
					...
					{Target: "parameters.Properties.LinkedServers", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.Properties.LinkedServers.Value", Name: validation.Null, Rule: true, Chain: nil}}},
				}}}}}); err != nil {
...
func (client GroupClient) CreatePreparer(resourceGroupName string, name string, parameters ResourceType, cancel <-chan struct{}) (*http.Request, error) {
...
func (client GroupClient) Update(resourceGroupName string, name string, parameters PatchResource) (result ResourceType, err error) {
...
func (client GroupClient) UpdatePreparer(resourceGroupName string, name string, parameters PatchResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"name":              autorest.Encode("path", name),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
