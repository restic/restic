...
// InvoicesListResult is result of the request to list invoices. It contains a list of available invoices in reverse
// chronological order.
...
// OperationListResult is result of the request to list billing operations. It contains a list of operations and a URL
